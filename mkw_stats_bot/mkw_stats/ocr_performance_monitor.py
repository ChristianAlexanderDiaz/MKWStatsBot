...
from .ocr_config_manager import OCRMode, OCRPriority, get_ocr_config
...
class AdaptiveBehaviorAnalyzer:
    ...
    def _detect_trend(self, metrics: list[PerformanceMetrics]) -> str:
        ...
        # Determine trend based on wait time changes
    ...
    def suggest_mode_optimization(self, current_stats: dict[str, Any]) -> OCRMode | None:
...
_performance_monitor: OCRPerformanceMonitor | None = None
