...
class OCRConfigManager:
    ...
    def should_trigger_mode_switch(self, usage_stats: dict[str, float]) -> OCRMode | None:
        """
        ...
        # Switch to BALANCED if mixed usage
            ...
            logger.info("Usage pattern suggests BALANCED mode (mixed usage)")
...
_config_manager: OCRConfigManager | None = None
